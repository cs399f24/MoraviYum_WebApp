...
cp fetch_vendor_foods.py $PACKAGE_DIR/
...
cd $PACKAGE_DIR
zip -r fetch_vendor_foods.zip .
mv fetch_vendor_foods.zip ..
cd ..
...
echo "Lambda function 'fetch_vendor_foods' created and published successfully."
